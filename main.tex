...
\makeatother
\title{Participatory Design of Learning Analytics Dashboards}
\date{January 2021}
...
To glean as much information as possible about the context and needs of users, a common strategy is to use participatory design techniques where end-users are directly invited to participate in the design process.  Participatory Design for Learning is a growing field with its own history, philosophies, and body of techniques and methods \cite{disalvo2017participatory}. In practical terms, the LA researchers used a subset of techniques such as pre-interviewing end-users about  their needs to derive design ideas \cite{xhakaj2016teachers}, employing practitioner-partners as informant designers who give feedback on 
...
The ANR HUBBLE project (HUman Observatory Based on analysis of e-Learning traces) promotes the creation of a national observatory for the construction and sharing of processes related to the analysis of massive data from traces left in e-learning environments. The Hubble project thus covers the entire process including the collection of traces, the calculation of indicators, the description of the analysis process and the provision of indicators in the form of learning dashboards. Within the framework of the Hubble project, the definition of models for the dynamic generation of learning dashboards has highlighted an insufficient capture of user needs for a mapping with existing indicators. A precise understanding of these needs for their capitalization has therefore proved to be crucial.
